...
import { Sparkles, ArrowRight, Loader2, Wand2, Lightbulb, MessageCircleQuestion, Info } from 'lucide-react';
                            ...
                            <div className="pt-4 border-t border-white/5 space-y-4">
                                <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 flex gap-3">
                                    ...
                                    <div className="text-xs text-blue-200/80 leading-relaxed">
                                        ...
                                        The AI Editor requires the Smart Content Solutions plugin to be active on your site to sync content and optimize posts.
                                    </div>
                                </div>
