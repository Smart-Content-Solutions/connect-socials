      ...
      if (currentTicket) {
        ...
        await createNotificationsForAdmins(
          supabase,
          {
            ...
            message: `${currentTicket.created_by_name || "Customer"} replied on: ${currentTicket.subject}`,
            entityType: "ticket",
          ...
          console.error("[Tickets/Comments] Failed to create in-app admin notification:", err);
        });
      }
